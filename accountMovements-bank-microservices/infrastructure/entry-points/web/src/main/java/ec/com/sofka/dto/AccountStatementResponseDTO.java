...
public class AccountStatementResponseDTO {
    ...
    public AccountStatementResponseDTO(String accountNumber, BigDecimal accountInitialBalance, BigDecimal accountAvailableBalance, String accountType, String customerName, String status, BigDecimal movementAmount, LocalDateTime date) {
